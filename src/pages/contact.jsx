...
export default function Contact() {
  ...
  return (
    <>
      <Head>
        <title>
          Contact Mystic Tarot Chat for Personalised Tarot Readings and Guidance
        </title>
        <meta
          name="description"
          content="Reach out to Mystic Tarot Chat for insightful tarot readings and expert guidance on your life's journey."
        />
        <link
          rel="canonical"
          href="https://mystictarotchat.com/contact"
          key="canonical"
        />
      </Head>
      <div className="px-6 py-24 bg-t isolate sm:py-32 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto text-center sm:pt-40 pt-28">
        ...
        >
          ...
          <input
            type="hidden"
            name="subject"
            value="Contact Mystic Tarot Chat"
          />
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            <div>
              <label
                htmlFor="first-name"
                className="block text-sm font-semibold leading-6 text-white/70"
              >
                First name
              </label>
            ...
            <Switch.Label className="text-sm leading-6 text-white/60">
              By selecting this, you agree to our{' '}
              <Link href="/privacy" className="font-semibold text-violet-600">
                privacy&nbsp;policy
              </Link>
              .
            </Switch.Label>
