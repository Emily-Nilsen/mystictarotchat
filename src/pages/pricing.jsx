      ...
      <div className="px-6 pt-24 mx-auto text-center max-w-7xl pb-96 sm:pt-32 lg:px-8">
        ...
        <div className="relative mt-6">
          <p className="max-w-2xl mx-auto text-lg leading-8 text-white/60">
            Experience the magic of a 30 minute personalised tarot reading with
            one of our experienced readers or delve deeper with a comprehensive
            60 minute full reading.
          </p>
          <svg
